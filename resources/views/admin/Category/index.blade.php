                                ...
                                <div class="table- mb-0" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table table-striped">
                                        ...
                                        @foreach($category as $item)
                                                    ...
                                                    <div class="">
                                                        <div class="btn-group me-1 mt-2">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <button class="dropdown-item" data-bs-toggle="modal"
                                                                        data-bs-target="#service{{$item->id}}">
                                                                    <i data-feather="edit-2" class="mr-50"></i>
                                            ...
                                            <div class="modal fade" id="service{{$item->id}}" tabindex="-1" aria-labelledby="edit" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">New message</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('service',$item->id)}}" method="post">
                                                                @csrf
                                                                <div class="mb-3">
